...
public class AddDialog extends BaseWindow implements ActionListener {
	...
	private final String[] labelText = { "学号", "姓名", "电话", "E-mail", "年龄",
			"学院", "性别" };
	private final String[] radioText = { "男", "女" };
	private final String[] btnText = { "null", "重置", "关闭" };
	private final String[] college = { "材料科学与工程学院", "交通学院", "管理学院", "机电工程学院",
			"能源与动力工程学院", "土木工程与建筑学院", "汽车工程学院", "资源与环境工程学院", "信息工程学院",
			"计算机科学与技术学院", "自动化学院", "航运学院", "物流工程学院", "理学院", "化学化工与生命科学学院",
			"经济学院", "艺术与设计学院", "外国语学院", "文法学院", "政治与行政学院", "国际教育学院", "马克思主义学院",
			"网络/继续教育学院", "职业技术学院", "体育部" };
	...
	public void setStudentInfo(Student s) {
		...
		if (s.isFemale())
			radio[0].setSelected(s.isFemale());
		else
			radio[1].setSelected(s.isFemale());
